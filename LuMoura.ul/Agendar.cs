    ...
    internal class Agendar
    {
        ...
        public void agendar(string Dataa, string Nome, string Telefone, string Servico, string Descricao, DataGridView dataGridView, string nomeServico)
        {
            if (dataGridView.SelectedRows.Count > 0)
            {
                ...
                using (SqlConnection conn1 = new SqlConnection("Data Source=FAC0539709W10-1;Initial Catalog=LuMoura.DB;User ID=sa;Password=123456;Connect Timeout=30;Encrypt=False;"))
                {
                    conn1.Open();
